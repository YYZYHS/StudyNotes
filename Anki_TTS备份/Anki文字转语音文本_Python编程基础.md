...
使用print()函数输出复杂的数据时，可以利用s e p参数和e n d参数。函数原型是：print(*objects, s e p='空格', e n d = '换航符', file=s y s点s t d out, flush=False)。例如，执行print("Hello", "World!","哈哈哈", s e p="星号 星号 星号", e n d="换航符")这航代码时，会输出Hello星号 星号 星号World!星号 星号 星号哈哈哈。为了在同一航输出多航内容，可以在print函数中使用e n d参数，例如print("Hello", e n d="右箭头")这航代码会输出Hello右箭头，接着执行print("World!")，输出World!。
...
四、注释分类：单航注释、多航注释和中文文档声明注释；

## Python0023 单行注释
单航注释有两种方式,一种是在代码后面加井号,另一种是单独一航写注释

## Python0024 多行注释
多航注释练习：多航注释本质上是字符串,可以用三个单引号或者三个双引号包裹。
